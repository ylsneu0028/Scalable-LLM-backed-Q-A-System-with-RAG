...
Experiment 1: concurrent POST /query on the API (full RAG: embed + vector + LLM).
  ...
  python scripts/loadtest_query.py --concurrency 5 --total 30 --output results/preliminary/exp1_c5.json

Requires Ollama running on the host. Uses varied questions to reduce accidental caching.
"""
